...
{
   $path="\\192.168.131.10\b2kcy\IT\!Pending\1BANKfiles\"
}

$XMLPath = "$path\MultiplePayments" + $monthName + $year + ".xml"
...
$paymentRowInfo = for ($i=$startRow; $i -le $endRow; $i++)
{
    ...
    $e.InnerText = "CY73002001950000357033370895"
